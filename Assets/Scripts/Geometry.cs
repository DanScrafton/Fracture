...
public class Geometry : MonoBehaviour
{
    ...
    /// </summary>
    public static bool To_The_Left(Vector2 p, Vector2 l0, Vector2 l1)
    {
    ...
    /// </summary>
    public static bool Inside_Circumcircle(Vector2 p, Vector2 c0, Vector2 c1, Vector2 c2)
    {
        var ax = c0.x - p.x;
        var ay = c0.y - p.y;
        var bx = c1.x - p.x;
    ...
    /// </summary>
    public static Vector2 Rotate_RightAngle(Vector2 v)
    {
        var x = v.x;
        v.x = -v.y;
        v.y = x;
    ...
    /// segments and rays.
    /// </summary>
    public static bool Line_Line_Intersection(Vector2 p0, Vector2 v0, Vector2 p1, Vector2 v1, out float m0, out float m1)
    {
    ...
    /// <summary>
    public static Vector2 Line_Line_Intersection(Vector2 p0, Vector2 v0, Vector2 p1, Vector2 v1)
    {
        float m0, m1;

        if (Line_Line_Intersection(p0, v0, p1, v1, out m0, out m1))
        {
            return p0 + m0 * v0;
        }
        else
    ...
    /// </summary>
    public static Vector2 Circumcircle_Center(Vector2 c0, Vector2 c1, Vector2 c2)
    {
        var mp0 = 0.5f * (c0 + c1);
        var mp1 = 0.5f * (c1 + c2);

        var v0 = Rotate_RightAngle(c0 - c1);
        var v1 = Rotate_RightAngle(c1 - c2);

        float m0, m1;

        Geometry.Line_Line_Intersection(mp0, v0, mp1, v1, out m0, out m1);
    ...
    /// and c2. 
    /// </summary>
    public static Vector2 Triangle_Centroid(Vector2 c0, Vector2 c1, Vector2 c2)
    {
